...
type SgnInFormProps = {
  form: SignInFormType;
  handleOnSubmit: (e: { preventDefault: () => void }) => Promise<void>;
  handleOnChange: (e: { target: { name: string; value: string } }) => void;
};

export default function SignInForm({ form, handleOnSubmit, handleOnChange }: SgnInFormProps) {
  return (
    <>
      <div>
      ...
      <div className="divide-y divide-gray-200 -mr-1 -ml-1 text-sm">
        ...
        >
          ...
          <div className="relative">
            <button className="bg-slate-700 text-white rounded-md py-2 w-full mt-3">Sign In</button>
          </div>
        </form>
      </div>
      ...
      <div className="text-center pt-0 px-1 sm:px-6 mt-4">
        <p className="mx-auto mb-6 leading-normal text-sm">
          Don&apos;t have an account?{' '}
          <Link href="/auth/sign-up" className="font-semibold bg-clip-text text-cyan-600">
            Sign up
          </Link>
        </p>
      </div>
